...
// Заменил на прямые параметры
// const GMAIL_EMAIL = process.env.GMAIL_EMAIL;
// const GMAIL_PASSWORD = process.env.GMAIL_PASSWORD;

const GMAIL_EMAIL = 'maximovfor@gmail.com'; // Укажите свою электронную почту
const GMAIL_PASSWORD = 'Z12345678u*'; // Укажите свой пароль
...
async function getMailList(chatId) {
    ...
    const client = new Pop3({
        ...
        debug: true, // Добавляем debug для TLS
    });
